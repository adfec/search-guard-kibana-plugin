...
export default function (kibana) {
    ...
    return new kibana.Plugin({
        ...
        uiExports: {
            hacks: [
                //'plugins/searchguard/authentication/chrome/logout_button',
                //'plugins/searchguard/authentication/services/access_control'
            ],
            apps: [{
                id: 'searchguard-multitenancy',
                title: 'Login',
                main: 'plugins/searchguard/authentication/apps/login',
                hidden: true,
                auth: false
            }],
            chromeNavControls: [
                'plugins/searchguard/authentication/chrome/btn_logout/btn_logout.js'
            ]
        },
